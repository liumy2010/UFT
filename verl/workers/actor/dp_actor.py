...
class DataParallelPPOActor(BasePPOActor):
    ...
    def _forward_micro_batch(self, micro_batch, temperature, return_prompt_logits=False) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        with torch.autocast(device_type='cuda', dtype=torch.bfloat16):
            ...
            return (entropy, log_probs) if not return_prompt_logits else (entropy, log_probs, prompt_logits)
    ...
    def update_policy(self, data: DataProto):
        ...
        for batch_idx, data in enumerate(dataloader):
            ...
            for data in micro_batches:
                ...
                # compute policy loss
                policy_loss = pg_loss - entropy_loss * entropy_coeff + sft_loss * self.config.sft_loss_coef
